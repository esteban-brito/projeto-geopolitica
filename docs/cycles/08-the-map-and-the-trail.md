...
> [ciclo 9](09-the-letter-asks-for-an-answer.md)**, que é o acordado.
>
...
[ciclo 9](09-the-letter-asks-for-an-answer.md), e não aqui.
...
> exatamente o que o [ciclo 10](10-who-brings-down-a-president.md) constrói. Ela deixa
...
| ----- | ------------------------------- | ------------------------------------- | ----- | -------------------------------------------------------- |
| **A** | a série da posição **e** o mapa | `state.mjs`, reducer, save, view, CSS | médio | depois do [ciclo 9](09-the-letter-asks-for-an-answer.md) |
