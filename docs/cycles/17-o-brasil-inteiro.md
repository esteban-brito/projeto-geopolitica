...
**A regra passa a valer para empresa, e o [ADR 0003](../adr/0003-o-mundo-e-real-as-pessoas-sao-inventadas.md)
...
fonte pública. O briefing [`research/01`](../research/01-briefing-brasil-2026.md), bloco 7,
...
> **A saída já está escrita, e é a opção 2 da Restrição 3 do [ciclo 13](13-o-glorioso.md):
