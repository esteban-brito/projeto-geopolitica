...
> **Escopo:** Exclusivamente descritivo e analítico (`docs/research/real-brazil-institutions.md`). Sem alterações em código de domínio, telas, testes ou dados calibrados.
