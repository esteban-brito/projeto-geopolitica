...
> Nada aqui foi implementado. Responde ao §25.2 da [especificação](especificacao-mestra.md):
...
| `forecast` (placar)                                                 | `inputs.mjs:33`; `mesa.mjs`                            | adesão verdadeira de todas as bancadas          | a estimativa do governo sobre crenças dele                   | D2     |
